...
parser.add_argument('--nblocks', type=str, default='8-8-8')
...
def create_fid(model):
    ...
    for i in range(fake_imgs.size()[0]):
        imgs = fake_imgs[i]
        filename = os.path.join(args.save, 'fid_samples', '_{:06d}.png'.format(i))
