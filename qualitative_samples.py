...
from lib.resflow import ACT_FNS, ResidualFlow, L2_Self_Attn
...
parser.add_argument('--nblocks', type=str, default='10-10-10')
...
#Namespace(act='swish', actnorm=True, add_noise=True, annealing_iters=0, attention=True, batchnorm=False, batchsize=16, begin_epoch=0, block='resblock', cdim=256, coeff=0.98, data='cifar10', dataroot='data', dropout=0.0, ema_val=True, factor_out=False, fc=False, fc_actnorm=False, fc_end=True, fc_idim=128, first_resblock=True, idim=512, imagesize=32, kernels='3-1-3', learn_p=False, lr=0.001, mem_eff=True, n_dist='poisson', n_exact_terms=2, n_lipschitz_iters=None, n_power_series=None, n_samples=1, nbits=8, nblocks='10-10-10', nepochs=1000, neumann_grad=True, nworkers=4, optimizer='adam', padding=0, padding_dist='uniform', preact=True, print_freq=20, quadratic=False, rcrop_pad_mode='reflect', resume=None, save='experiments/cifar10/attention-True', scale_dim=False, scheduler=False, seed=31696, sn_tol=0.001, squeeze_first=False, task='density', update_freq=1, val_batchsize=200, var_reduc_lr=0, vis_freq=200, vnorms='2222', warmup_iters=1000, wd=0)
W = args.ncol
H = args.nrow
